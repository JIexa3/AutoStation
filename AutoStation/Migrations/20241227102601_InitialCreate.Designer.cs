...
namespace AutoStation.Migrations
{
    ...
    [Migration("20241227102601_InitialCreate")]
            ...
            modelBuilder.Entity("AutoStation.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            VerificationCodeExpiry = new DateTime(2025, 12, 27, 14, 26, 1, 651, DateTimeKind.Local).AddTicks(6080)
                        });
                });
