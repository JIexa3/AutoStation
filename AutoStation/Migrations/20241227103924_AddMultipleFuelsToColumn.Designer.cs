...
namespace AutoStation.Migrations
{
    ...
    [Migration("20241227103924_AddMultipleFuelsToColumn")]
    partial class AddMultipleFuelsToColumn
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AutoStation.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            VerificationCodeExpiry = new DateTime(2025, 12, 27, 14, 39, 24, 600, DateTimeKind.Local).AddTicks(7601)
                        });
                });
